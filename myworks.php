<?include ('header.php');?>
	...
	<div class="b-breadcrumbs">
		<div class="b-block">
			...
			<a href="/1store/category.php">Личный кабинет</a>
			<a href="#" onclick="return false;">Мои работы</a>
		</div>
	</div>
	<div class="b-my-works-block wave-bottom">
		<div class="b-block">
			<div class="b-my-works-top">
				<h2>Мои работы</h2>
				<p>Тут вы можете делиться своими работами с другими посетителями магазина.</p>
