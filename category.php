<?include ('header.php');?>
	...
	<div class="b-breadcrumbs">
		<div class="b-block">
			...
			<a href="/1store/category.php">Инвентарь</a>
			<a href="#" onclick="return false;">Для работы с кремом</a>
		</div>
	</div>
	<div class="b-category wave-bottom">
		<div class="b-block">
			<h2>Кондитерский инвентарь</h2>
			<div class="b-category-list">
				<div class="b-catalog-item b-category-item">
					<a href="subcategory.html" class="b-catalog-img" style="background-image:url('i/news-item-1.jpg');"></a>
					<div class="b-catalog-item-top">
						...
						<div class="b-category-item-inner">
							<ul>
								...
								<li><a href="#">Бузмены</a></li>
								<li><a href="#">Кухонные весы</a></li>
								<li><a href="#">Кухонные зажигалки</a></li>
								<li><a href="#">Таймеры</a></li>
								<li><a href="#">Термометры</a></li>
								<li><a href="#">Великолепные кастрюли</a></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="b-catalog-item b-category-item">
					<a href="#" class="b-catalog-img" style="background-image:url('i/news-item-1.jpg');"></a>
					<div class="b-catalog-item-top">
						<div class="b-category-item-back"></div>
						<div class="b-category-item-outer">
							<h6>Для работы с кремом</h6>
				...
				<div class="b-catalog-item b-category-item">
					<a href="#" class="b-catalog-img" style="background-image:url('i/news-item-2.jpg');"></a>
					<div class="b-catalog-item-top">
						<div class="b-category-item-back"></div>
						<div class="b-category-item-outer">
							<h6>Для работы с кремом</h6>
				...
				<div class="b-catalog-item b-category-item">
					<a href="#" class="b-catalog-img" style="background-image:url('i/news-item-3.jpg');"></a>
					<div class="b-catalog-item-top">
						<div class="b-category-item-back"></div>
						<div class="b-category-item-outer">
							<h6>Для работы с кремом</h6>
				...
				<div class="b-catalog-item b-category-item">
					<a href="#" class="b-catalog-img" style="background-image:url('i/news-item-4.jpg');"></a>
					<div class="b-catalog-item-top">
						<div class="b-category-item-back"></div>
						<div class="b-category-item-outer">
							<h6>Для работы с кремом</h6>
		...
		<div class="b-block">
			<div class="b-two-blocks">
				<div class="b-block-1 b-two-blocks-item">
					...
					<h4>Узнавайте об <b>акциях и новинках</b> первыми</h4>
