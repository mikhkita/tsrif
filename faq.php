<?include ('header.php');?>
	...
	<div class="b-breadcrumbs">
		<div class="b-block">
			...
			<a href="#" onclick="return false;">Часто задаваемые вопросы</a>
		</div>
	</div>
				...
				<div class="b-block-1">
					<div class="b-category-left-list">
						<ul>
							...
							<li><a href="#" class="active">Часто задаваемые вопросы</a></li>
					...
					<div class="b-faq-list">
						<div class="b-faq-item with-img">
							...
							<div class="b-faq-content">
								<div class="b-faq-img" style="background-image:url('i/catalog-item-1.jpg')"></div>
