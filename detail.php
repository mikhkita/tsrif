<?include ('header.php');?>
		...
		<div class="b-block">
			<div class="b-detail-left-block">
				...
				<div class="b-detail-bottom-slider">
					<div class="b-detail-small-pic" style="background-image: url('i/catalog-item-1.jpg');"></div>
					<div class="b-detail-small-pic" style="background-image: url('i/catalog-item-2.jpg');"></div>
					<div class="b-detail-small-pic" style="background-image: url('i/catalog-item-3.jpg');"></div>
					<div class="b-detail-small-pic" style="background-image: url('i/catalog-item-4.jpg');"></div>
					<div class="b-detail-small-pic" style="background-image: url('i/catalog-item-5.jpg');"></div>
					<div class="b-detail-big-pic" style="background-image: url('i/catalog-item-3.jpg');"></div>
				</div>
			</div>
	...
	<div class="about-advantages detail-advantages">
		...
		<div class="b-block">
			...
			<div class="about-advantages-item" style="background-image: url('i/detail-adv-1.svg');">
